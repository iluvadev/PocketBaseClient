...
{
    /// <summary>
    /// Filter definitions for Fields of type Number (Integer)
    /// </summary>
    public class FieldFilterNumberInt : FieldFilter
    {
        /// <summary>
        /// Ctor
        /// </summary>
        /// <param name="fieldName"></param>
        public FieldFilterNumberInt(string fieldName) : base(fieldName)
        {
        }
