...
namespace PocketBaseClient.SampleApp.Models
{
    public partial class TestForTypes : ItemBase
    {
        ...
        public static async Task<TestForTypes?> GetByIdAsync(string id, bool forceLoad = false)
            => await DataServiceBase.GetCollection<TestForTypes>()!.GetByIdAsync(id, forceLoad);
        #endregion GetById
    }
}
