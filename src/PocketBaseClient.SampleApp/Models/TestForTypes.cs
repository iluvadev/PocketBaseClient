...
namespace PocketBaseClient.SampleApp.Models
{
    public partial class TestForTypes : ItemBase
    {
        ...
        public static CollectionTestForTypes GetCollection() 
            => (CollectionTestForTypes)DataServiceBase.GetCollection<TestForTypes>()!;
        #endregion Collection


        #region GetById
        public static TestForTypes? GetById(string id, bool reload = false) 
            => GetByIdAsync(id, reload).Result;

        public static async Task<TestForTypes?> GetByIdAsync(string id, bool reload = false)
            => await DataServiceBase.GetCollection<TestForTypes>()!.GetByIdAsync(id, reload);
        #endregion GetById
    }
}
