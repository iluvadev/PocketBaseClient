...
using static PocketBaseClient.DemoTest.Models.TestForTypes;

namespace DemoTest.ConsoleApp
{
    internal class ExampleUssage
    {
        public static void Example1()
        {
            var app = new DemoTestApplication();
        ...
        public static void Example2()
        {
            ...
            if (!post1.Metadata_.IsValid)
            {
                foreach (var validationError in post1.Metadata_.ValidationErrors)
